	...
	$.fn.extend({
		lSelect: function(options) {
			...
			var settings = {
				choose: "请选择...",
				emptyValue: "",
				cssStyle: {"margin-right": options.margin?options.margin:'20px',"width": options.width?options.width :'140px',"display":"inline"},
				url: null,
				type: "GET"
			};
			...
			return this.each(function() {
				...
				function addSelect($position, parentId, currentId) {
					...
					var select = '<select class="select"  name="' + selectName + '">';
