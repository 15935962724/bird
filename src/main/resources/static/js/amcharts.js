...
(function () {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length &&
                "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e); else "object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.dateFormats = [{period: "fff", format: "JJ:NN:SS"},
                {period: "ss", format: "JJ:NN:SS"}, {period: "mm", format: "JJ:NN"}, {
                    period: "hh",
                    format: "JJ:NN"
                }, {period: "DD", format: "MMM DD"}, {period: "WW", format: "MMM DD"}, {
                    period: "MM",
                    format: "MMM"
            ...
            var a, b = this.chart, c = this.showFirstLabel, e = this.showLastLabel, h, f = "",
                ...
                r = this.firstDayOfWeek, t = this.boldPeriodBeginning;
            a = this.minorGridEnabled;
            var u, z = this.gridAlpha, w,
                x = this.choosePeriod(0), v = x.period, x = x.count, A = d.getPeriodDuration(v, x);
            ...
            if (0 < this.gridCountR) for (a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < x; h += u) this.gridAlpha =
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
                ...
                var w, x = this.guides, v = x.length;
                if (0 < v) {
                    var A = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < v; g++) {
                        var B = x[g], D = NaN, C = B.above;
                ...
                var u = this.step, H, x = this.minorGridAlpha;
                this.minorGridEnabled && (H = this.getMinorGridStep(u, this.stepWidth * u));
                if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (g = f; g < r; g += p) if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min),
            ...
            for (l = this.start; l <= this.end; l++) {
                var t = 0;
                for (q = 0; q < k.length; q++) if (n = k[q], n.hidden) n.newStack && (h[l] = NaN, e[l] = NaN); else if (m = n.type, n.chart ==
                this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[l] = NaN, e[l] = NaN); else {
            ...
            if (this.includeGuidesInMinMax && 0 < a) for (b = 0; b < a; b++) c = this.guides[b], c.toValue < this.min && (this.min = c.toValue), c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue), c.value >
            ...
            var a = this.synchronizeWith, b = a.min,
                c = a.max, a = a.step, e = this.synchronizationMultiplier;
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy,
                l = a.viX, m = a.viY, n = a.viH, q = a.viW, p = b.container;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var z = a.chart.container, w = z.set();
            this.set = w;
            var x = a.axisThickness, v = a.axisColor, A = a.axisAlpha, B = a.tickLength, D = a.gridAlpha,
                C = a.gridThickness, I = a.gridColor, H = a.dashLength, O = a.fillColor, J = a.fillAlpha,
                da = a.labelsEnabled;
            n = a.labelRotation;
            var pa = a.counter, U = a.inside, na = a.labelOffset, qa = a.dx, ja = a.dy, Pa = a.orientation,
                aa = a.position, Z = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, ca, ta;
            ...
            var ia = "start";
            h && (ia = "middle");
            var Q = n * Math.PI / 180, W, wa, G = 0, y = 0, ka = 0, ea = W = 0, Qa = 0;
            "V" == Pa && (n = 0);
            var Y;
            ...
            Y && (Y.attr({"text-anchor": ia}), Y.translate(G, y), 0 !== n && Y.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Y), this.label = Y, d.setCN(p, Y, a.bcn + "label"), d.setCN(p, Y, q, !0), g && d.setCN(p,
                Y, "guide"));
...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            this.linkSet.remove(), this.linkSet = a.set()) : this.fire("failed", {type: "failed", chart: this})
        }, premeasure: function () {
            var a = this.div;
            if (a) {
            ...
            if (a) {
                ...
                var f = d.removePx(d.getStyle(a, "padding-left")), g = d.removePx(d.getStyle(a,
                    "padding-right")), k = d.removePx(d.getStyle(a, "padding-top")),
            ...
            a = {
                x: a, y: b, text: c, align: e, size: d, color: f, alpha: k, rotation: g, bold: l, url: m,
                enabled: !0
            };
        ...
        addTitle: function (a, b, c, e, d) {
            ...
            if (!this.skipEvents) {
                ...
                this.chartRendered || (a = "rendered", this.fire(a, {type: a, chart: this}),
            ...
            this.chartCreated && (this.dataChanged =
                !0, this.marginsUpdated = "xy" != this.type ? !1 : !0, this.initChart(a))
        ...
        hideBalloonReal: function () {
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = 1E3 * b.time / d.updateRate, e = b.frame + 1, h = b.obj,
                    f = b.attribute;
                if (e <= c) {
                    b.frame++;
        ...
        inIframe: function () {
            ...
            if ("amcharts.com" != b || !0 === this.inIframe()) {
                ...
                var g = "http://www.amcharts.com/javascript-charts/", k = "JavaScript charts",
                    l = "";
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            if (e) {
                ...
                var p = l.columnGraphics, r = 0, t = 0;
                p && (r = p.x, t = p.y);
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, r = this.rotate,
                t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), z = this.connect, w = [], x = [],
                v, A, B, D, C = this.chart.graphs.length, I, H = this.dx / this.tcc, O = this.dy / this.tcc,
                J = f.stackType, da = this.start, pa = this.end, U = this.scrollbar, na = "graph-column-";
            U && (na = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ja = this.baseCoord, Pa = this.negativeBase,
                aa = this.columnIndex, Z = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR,
                ba = this.dashLength, ca = this.set, ta, ia = this.getGradRotation(), Q = this.chart.columnSpacing,
                W = qa.cellWidth, wa = (W * k - t) / t;
            Q > wa && (Q = wa);
            var G, y, ka, ea = q + 1, Qa = n + 1, Y = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR,
                Ja = this.negativeFillColors, Ca = this.negativeLineColor, Wa = this.fillAlphas,
            ...
            for (K = da; K <= pa; K++) {
                ...
                var T, P, M,
                    fa, la = NaN, F = NaN, E = NaN, N = NaN, L = NaN, Na = NaN, Da = NaN, Oa = NaN, Ea = NaN, ya = NaN,
                    za = NaN, ga = NaN, ha = NaN, X = NaN, vb = NaN, wb = NaN, ma = NaN, oa = void 0, Ia = tb, Sa = Wa,
                    Aa = sa, ua, xa, xb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ba) {
                    ...
                    var la = G.x[qa.id], Ta = this.periodSpan - 1, ra = Math.floor(W / 2) + Math.floor(Ta * W / 2),
                        Fa = ra, lb = 0;
                    ...
                    switch (g) {
                        ...
                        case "step":
                            if (!isNaN(X)) {
                                ...
                                if (Ya || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) {
                                    var Yb = w[w.length - 2], Zb = x[x.length - 2];
                                    w.pop();
                                    x.pop();
                        ...
                        case "column":
                            ...
                            if (!isNaN(X)) {
                                ...
                                if (oa && (xa = oa.set, d.setCN(a, oa.set, "graph-" + this.type), d.setCN(a, oa.set, "graph-" + this.id), y.className && d.setCN(a, oa.set, y.className, !0), y.columnGraphics = xa, xa.translate(T, P), this.columnsSet.push(xa), (y.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), !U)) {
                                    ...
                                    this.columnsArray.push({column: oa, depth: I});
                                    y.x = r ? P + M / 2 : T + M / 2;
                        ...
                        case "ohlc":
                            if (!(isNaN(ma) || isNaN(vb) || isNaN(wb) || isNaN(X))) {
                                ...
                                var mb, nb, ob;
                                if (r) {
                                    var Db = E - k / 2, Db = d.fitToBounds(Db, 0, q), Ob = d.fitToBounds(E, 0, q),
                                        Eb = E + k / 2, Eb = d.fitToBounds(Eb, 0, q);
                                    ...
                                    var Fb = F - k / 2, Fb = d.fitToBounds(Fb, 0, n), Pb = d.fitToBounds(F, 0, n),
                                        Gb = F + k / 2, Gb = d.fitToBounds(Gb, 0, n);
                    ...
                    if (!U && !isNaN(X)) {
                        ...
                        if (this.end - this.start <= Qb || 0 === Qb) {
                            var Rb = this.createBullet(y, ga, ha, K), Sb = this.labelText;
                            if (Sb && Rb) {
                            ...
                            if ("regular" == J || "100%" == J) {
                                ...
                                if (Tb) {
                                    ...
                                    var Ub = Va.getBBox(), Vb = Ub.width, Wb = Ub.height,
                                        bb, cb, pb = f.totalTextOffset, Xb = f.totals[K];
                                    Xb && Xb.remove();
                                    var db = 0;
        ...
        animateColumns: function (a, b) {
            ...
            if (1 < a.length) {
                ...
                f.push(m);
                f.push(l);
                var n = h.lineAlpha, q = h.lineThickness, f = h.fillAlphas, p = h.lineColorR, r = h.negativeLineAlpha;
                isNaN(r) && (r = n);
                ...
                var u = h.negativeLineColor, w = h.negativeFillColors, x = h.negativeFillAlphas, v = h.baseCoord;
                ...
                if (0 < f || 0 < x) if (q = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n ? 0 < c.length ? (c.reverse(), e.reverse(), q = a.concat(c), r = b.concat(e)) : h.rotate ? (r.push(r[r.length - 1]), q.push(v), r.push(r[0]), q.push(v), r.push(r[0]), q.push(q[0])) : (q.push(q[q.length - 1]), r.push(v), q.push(q[0]), r.push(v), q.push(a[0]), r.push(r[0])) : "xy" == n && (b =
            ...
            if (1 < a.length) {
                ...
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas,
                    p = this.lineColorR, r = this.fillColorsR, t = this.negativeLineColor, u = this.negativeFillColors,
                    z = this.negativeFillAlphas, w = this.baseCoord, x = this.lineColorSwitched;
                x && (p = x);
            ...
            if (!isNaN(b) && !isNaN(c)) {
                var e = this.chart, h = this.container, f = this.bulletOffset,
                    g = this.bulletSize;
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            if (a.mouseIsOver) {
                ...
                -.5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c), this.setPosition()) :
        ...
        destroy: function () {
            ...
            var c =
                this.chart, e = this.fullWidth, h = c.mouseX - this.x, f = c.mouseY - this.y;
            ...
            if (this.enabled) {
                ...
                var g = c.categoryAxis, k = c.dx, l = c.dy, m = this.x + 1, n = this.y + 1, q = this.width,
                    p = this.height, r = this.data[a];
                this.fireMoved();
                if (r) {
                    var t = r.x[g.id], u = c.rotate, z = this.stepWidth, w = this.categoryBalloon, x = this.firstTime,
                        v = this.lastTime, A = this.cursorPosition, B = this.zooming, D = this.panning, C = c.graphs;
                    if (c.mouseIsOver || B || D || this.forceShow) if (this.forceShow = !1, D) {
                        var k = this.panClickPos, c = this.panClickEndTime, B = this.panClickStartTime,
                            I = this.panClickEnd, m = this.panClickStart, h = (u ? k - f : k - h) / z;
                        ...
                        0 < this.cursorAlpha && (u ? (v = 0, z = t + l, e && (z -= g.cellWidth / 2)) : (v = t, z = 0, e && (v -= g.cellWidth / 2)), A =
                            this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ? x.translate(v, z) : (x.translate(this.previousX, this.previousY), x.animate({translate: v + "," + z}, A, "easeOutSine")) : x.translate(v, z), this.previousX = v, this.previousY = z, x.show());
                        ...
                        if (a !=
                            this.previousIndex || I != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], C && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                            this.valueBalloons = t = [];
                            for (g = 0; g < C.length; g++) if (w = C[g], v = NaN, (!this.oneBalloonOnly || w == I) && w.showBalloon && !w.hidden && w.balloonText && ("step" == w.type && "left" == w.stepDirection && (r = this.data[a + 1]), r)) {
                                if (x = r.axes[w.valueAxis.id].graphs[w.id]) v = x.y;
                                if (this.showNextAvailable && isNaN(v) && a + 1 < this.data.length) for (z = a + 1; z < this.data.length; z++) if (e =
                                    this.data[z]) if (x = e.axes[w.valueAxis.id].graphs[w.id], v = x.y, !isNaN(v)) break;
                                if (!isNaN(v)) {
                                    e = x.x;
                                    l = !0;
                                    if (u) {
                        ...
                        b ?
                            (k = {type: "changed"}, k.index = a, k.chart = this.chart, k.zooming = B, k.mostCloseGraph = I, k.position = u ? f : h, k.target = this, c.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
            ...
            var e = b.position, d = b.inside, f = b.axisThickness, g = b.tickLength, k = this.chart, l = k.dx, k = k.dy,
                m = this.x, n = this.y, q = this.width, p = this.height;
        ...
        handleMouseOut: function () {
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                        ...
                        if ("cursor" == this.type) this.rotate ? this.selectionPosY = h : this.selectionPosX = h = e, 4 > Math.abs(h - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index,
                            c.start = this.fromIndex), h = a.categoryAxis, h.parseDates && !h.equalSpacing && (b[c.start] && (c.start = b[c.start].time), b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c)); else {
            ...
            if (this.zoomable || this.pan || this.drawing) {
                var b = this.rotate, c = this.chart, e = c.mouseX - this.x, h = c.mouseY -
                    this.y;
        ...
        construct: function (a) {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ?
                    (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (c = Math.round(c), m ? h.animate({y: c}, e, ">") : h.animate({x: c}, e, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var g = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, q = this.fillColor,
                        p = this.borderColor, r = q;
                    void 0 != n && (this.adjustBorderColor ? r = p = n : q = n);
                    var t = this.horizontalPadding, u = this.verticalPadding, z = this.pointerWidth,
                        w = this.pointerOrientation, x = this.cornerRadius, v = c.fontFamily, A = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = A + u, m = D + t, u = this.shadowAlpha, H = this.shadowColor, t = this.borderThickness,
                        O = this.bulletSize, J;
    ...
    d.AmSlicedChart = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            for (b = 0; b < a.length; b++) {
                var c = a[b];
                if (c.label) {
                    var e = c.ty, e = d.line(this.container, [c.tx0, c.tx, c.tx2], [c.ty0, e, e], this.labelTickColor,
                        this.labelTickAlpha);
    ...
    d.AmRectangularChart = d.Class({
        inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            if (!a.zbSet) {
                ...
                var c = a.color, e = a.fontSize, h = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage,
                    g = d.lang.zoomOutText || a.zoomOutText, k = a.zoomOutButtonColor, l = a.zoomOutButtonAlpha,
                    m = a.zoomOutButtonFontSize, n = a.zoomOutButtonPadding;
                isNaN(m) || (e = m);
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, e = this.marginTopReal, h = this.plotAreaWidth - 1,
                f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, k = this.plotAreaFillAlphas,
                l = this.plotAreaBorderColor, m = this.plotAreaBorderAlpha;
            "object" == typeof k && (k = k[0]);
            g = d.polygon(this.container, [0,
                h, h, 0, 0], [0, 0, f, f, 0], g, k, 1, l, m, this.plotAreaGradientAngle);
            ...
            var a = this.valueAxes,
                b = this.marginLeftReal, c = this.marginTopReal, e = this.plotAreaHeight, h = this.plotAreaWidth, f;
            ...
            var c = a.position, e = a.scrollbarHeight +
                a.offset;
            ...
            if (a) {
                a.rotate = b;
                var c = this.marginTopReal, e = this.marginLeftReal, d = a.scrollbarHeight, f = this.dx, g = this.dy,
                    k = a.offset;
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                n = a.finalDate, q = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, t = a.initialXValue,
                u = a.finalXValue, z = a.initialValue, w =
                    a.finalValue, x = p.recalculateToPercents, v = b.dataDateFormat;
...
(function () {
    ...
    d.makeHD = function (a, b, c) {
        for (var d = [], h = [], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        g = r(g);
        k = r(k);
        var t = r(g / f * k), u = d.VML, z = 359.5 + f / 100;
        359.94 < z && (z = 359.94);
        h >= z &&
        (h = z);
        var w = 1 / 180 * Math.PI, z = b + Math.sin(e * w) * k, x = c - Math.cos(e * w) * t,
            v = b + Math.sin(e * w) * f, A = c - Math.cos(e * w) * g, B = b + Math.sin((e + h) * w) * f,
            D = c - Math.cos((e + h) * w) * g, C = b + Math.sin((e + h) * w) * k, w = c - Math.cos((e + h) * w) * t,
            I = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, H = 0;
        180 < Math.abs(h) && (H = 1);
        e = a.set();
        var O;
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
                h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumns,
                m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, r = 0, t = this.container;
            this.set && this.set.remove();
            var u = t.set();
            this.set = u;
            var z = t.set();
            u.push(z);
            var w = this.entries, x, v;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize,
                        e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3; else {
                        var r;
