...
import com.bird.shiro.AdminShiroRealm;
//import com.bird.shiro.MemberShiroRealm;
import com.bird.shiro.MyRetryLimitCredentialsMatcher;
...
//    public DefaultWebSecurityManager getDefaultWebSecurityManager(@Qualifier("adminShiroRealm") AdminShiroRealm adminShiroRealm){
...
//    }
    ...
    @Bean(name="securityManager")
    public DefaultWebSecurityManager getDefaultWebSecurityManage(@Qualifier("adminShiroRealm") AdminShiroRealm adminShiroRealm){
...
//        realm.setCacheManager((adminHashedCredentialsMatcher());
//        //没有配置权限缓存,所以关闭授权缓存域
//        realm.setAuthorizationCachingEnabled(false);
        return adminShiroRealm;
    }

//    @Bean(name="memberShiroRealm")
//    public MemberShiroRealm memberShiroRealm(){
//        System.out.println("ShiroConfiguration.customShiroRealm()");
//        MemberShiroRealm memberShiroRealm = new MemberShiroRealm();
//        memberShiroRealm.setCredentialsMatcher(memberHashedCredentialsMatcher());
...
//        hashedCredentialsMatcher.setHashIterations(1024);//散列的次数，当于 m比如散列两次，相d5(md5(""));
//        hashedCredentialsMatcher.setStoredCredentialsHexEncoded(true);
//        return hashedCredentialsMatcher;
//    }
//
//    @Bean(name = "memberHashedCredentialsMatcher")
//    public HashedCredentialsMatcher memberHashedCredentialsMatcher(){
//        HashedCredentialsMatcher hashedCredentialsMatcher = new HashedCredentialsMatcher();
//        hashedCredentialsMatcher.setHashAlgorithmName("md5");//散列算法:这里使用MD5算法;
//        hashedCredentialsMatcher.setHashIterations(1024);//散列的次数，当于 m比如散列两次，相d5(md5(""));
//        hashedCredentialsMatcher.setStoredCredentialsHexEncoded(true);
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(">>>"+shiroEncryption("TEAM_x*1112","admin_SP"));
    }
